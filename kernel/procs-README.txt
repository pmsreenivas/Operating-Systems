...
(E.1) In order to test the condition of process calling proc_kill on itself, use the kshell command: sc_proc_k
(E.2) In order to test the condition of thread calling kthread_cancel on itself, use the kshell command: sc_kt_can
...
Self check kshell commands:

In order to test process calling proc_kill on itself, run kshell command: sc_proc_k
In order to test thread calling kthread_cancel on itself, run kshell command: sc_kt_can
