...
also fine).
    ...
    To compile your code, the grader should type: make or make warmup1 to obtain warmup1 executable
						  make listtest to obtain listtest executable
